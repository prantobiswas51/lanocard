            ...
            <div class="grid lg:grid-cols-[1.5fr,1.1fr] gap-5 items-start">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl p-4 sm:p-5 space-y-4 shadow-sm text-sm">
                    ...
                    <div class="space-y-2 text-[11px]">
                        ...
                        @empty
                        <div id="notificationHistoryEmptyState" class="px-6 py-10 flex flex-col items-center justify-center text-center gap-3">
                                <div class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-500">
